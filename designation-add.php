...
$name=$db->escape(ucwords(strtolower($_POST['designation'])));
$department=$db->escape($_POST['department']);
$table="tbldesignation";
$exists = $data->exist($table,"designation",$name);
        
  if($exists) {
            $error = 2;
  } else {
    
    $fields="department_id,designation,create_at,update_at";

    $values="'".$department."','".$name."',NOW(),NOW()";
...
$alldepartments=$data->selectFieldsWithId("tbldepartment","department");
?>
<!DOCTYPE html>
<html>
<head>
              ...
              <form role="form" action="" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select name="department" class="form-control" id="exampleInputDepartment" >
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="designation" class="form-control" id="exampleInputDesignation">
